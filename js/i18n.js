...
var I18nManager = {
  ...
  translations: {
    en: {
      ...
      tabLaws: '🌌 Undiscovered Universal Laws',
      ...
      instructionLaws: 'Speculative universal laws derived by thinkers that remain undiscovered in the real world',
      searchPlaceholder: '🔍 Search beliefs or thinker name...',
      searchStreamPlaceholder: '🔍 Search mutated belief or agent name...',
      searchLawsPlaceholder: '🔍 Search speculative undiscovered universal laws...',
      ...
      lawsHeader: '🌌 Undiscovered Universal Laws Matrix (Emergent Breakthroughs)',
      lawsCountBadge: 'New Laws',
      lawsEmpty: 'No speculative universal laws synthesized yet. Start simulation to trigger cross-domain breakthroughs!',
      plausibilityLabel: 'Plausibility Rating:',
      coDerivedBy: 'Co-Derived By:',
      realWorldStatusLabel: 'Real-World Status:',
    ...
    zh: {
      ...
      instructionLaws: '通过 25 位思想家跨学科对谈涌现出的、真实世界尚未发现但可能真实存在的法则规律',
      searchPlaceholder: '🔍 搜索认知观点或思想家姓名...',
      searchStreamPlaceholder: '🔍 搜索突变认知或思想家...',
      searchLawsPlaceholder: '🔍 搜索尚未被真实世界发现的潜法则...',
      ...
      lawsHeader: '🌌 尚未被真实世界发现的可能法则矩阵 (跨学科涌现突破)',
      lawsCountBadge: '项新法则',
      lawsEmpty: '暂未合成出新的可能法则。点击“开始仿真演练”触发思想家跨界突破！',
      plausibilityLabel: '理论可信度研判：',
      coDerivedBy: '联合推导思想家：',
      realWorldStatusLabel: '真实世界学术研判：',
